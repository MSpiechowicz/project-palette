...
export function ProjectColorGenerated() {
  const { palette, showTextPreview, setBaseColor, setPalette } =
    useColorStore();
    ...
    <>
      <div className="mb-6">
        ...
        <p className="text-slate-800 mb-4 max-w-[80ch]">
          Discover additional colors generated from your base color. Each color
          maintains perfect harmony with your primary choice. Click any color to
          ...
          <div key={`${color.hex}-${index}`} className="group">
            ...
            >
              ...
              <div className="w-full h-28 relative bg-white flex flex-col items-start justify-center px-4">
                <h3 className="text-black underline underline-offset-3 font-bold mb-1">
                  {color.name}
                </h3>
                <div className="flex items-center">
                  <img
                    src={EyeDropper}
                    alt="Eye Dropper"
                    className="w-4 h-4 mt-1 mr-0.5"
                  />
                  <span className="text-black text-sm ml-1 mt-1">
                    {color.hex}
                  </span>
                </div>
                <div className="flex items-center">
                  ...
                  <span className="text-black text-sm ml-1 mt-1">
                    {getWcagLevelDescription(color.wcagLevel)}
                  </span>
                </div>
              </div>
            </button>
